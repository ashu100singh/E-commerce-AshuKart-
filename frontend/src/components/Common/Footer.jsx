		...
		<footer className='border-t py-12'>
			<div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
				<div>
					...
					<form className='flex'>
						<input
							...
							className='w-full p-3 text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all'
							required
						/>
				...
				<div>
					...
					<ul className='space-y-2 text-gray-600'>
						...
						<li>
							<Link to='#' className='hover:text-gray-500 transition-colors'>Men's Botttom Wear</Link>
						</li>
						<li>
			...
			<div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
				<p className='text-gray-500 text-center text-sm tracking-tighter'>
					© 2025, Ashutosh Singh - All Rights Reserved
				</p>
			</div>
		</footer>
	)
