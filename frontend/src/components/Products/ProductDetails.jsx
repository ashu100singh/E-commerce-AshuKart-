            ...
            {selectedProduct && (
                <div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
                    <div className='flex flex-col md:flex-row'>
                        ...
                        <div className='hidden md:flex flex-col space-y-4 mr-6'>
                            {
                                selectedProduct.images.map((image, index) => (
                                    <img key={index}
                                        ...
                                        className={`h-20 w-20 object-cover rounded-lg cursor-pointer border-2 ${mainImage === image.url ? "border-black" : "text-gray-300"}`}
                        ...
                        <div className='md:w-1/2 md:ml-10'>
                            ...
                            <button 
                                ...
                                className={`bg-black text-white py-2 px-6 rounded-md w-full mb-4 ${isButtonDisabled ? "cursor-not-allowed bg-black/50":"hover:bg-gray-900"}`}
                            >
                    ...
                    <div className='mt-20'>
                        ...
                        <ProductGrids products={similarProducts} loading={loading} error={error}/>
                    </div>
